...
LIVE_SIMULATOR_INTERVAL_SECONDS = int(os.getenv("LIVE_SIMULATOR_INTERVAL_SECONDS", "2"))
LIVE_SIMULATOR_SAMPLE_ROWS = int(os.getenv("LIVE_SIMULATOR_SAMPLE_ROWS", "5000" if PRODUCTION else "4000"))
LIVE_SIMULATOR_TICKS_PER_INTERVAL = int(os.getenv("LIVE_SIMULATOR_TICKS_PER_INTERVAL", "5"))
